...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Doctor.glav_doctore'
        db.add_column('doctor', 'glav_doctore',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Doctor.glav_doctore'
        db.delete_column('doctor', 'glav_doctore')
    ...
    models = {
        ...
        u'medic.patient': {
            ...
            'diagnoz': ('django.db.models.fields.TextField', [], {}),
            'firstName': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastName': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
