...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patient.diagnoz'
        db.add_column('patient', 'diagnoz',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Patient.vypisan'
        db.add_column('patient', 'vypisan',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patient.diagnoz'
        db.delete_column('patient', 'diagnoz')

        # Deleting field 'Patient.vypisan'
        db.delete_column('patient', 'vypisan')
    ...
    models = {
        ...
        u'medic.doctor': {
            'Meta': {'object_name': 'Doctor', 'db_table': "'doctor'"},
            'firstName': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'glav_doctore': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'zvanie': ('django.db.models.fields.CharField', [], {'max_length': '300'})
        },
        u'medic.patient': {
